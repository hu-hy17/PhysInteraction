...
namespace cudax {
	class ComputeJacobianKeypoint2D : public ComputeJacobianRow {
	private:
...
//		int* sensor_dtform_idxs;
	...
	public:
		ComputeJacobianKeypoint2D(J_row* J_raw, float* e_raw) : ComputeJacobianRow(J_raw, e_raw) {
