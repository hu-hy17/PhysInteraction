...
Jacobian* J2 = NULL; ///< semi-preallocated memory to store jacobian
thrust::device_vector<float>* F2 = NULL; ///< effectors (same # columns as J)
thrust::device_vector<float>* JtJ2 = NULL; ///< preallocated memory NUM_THETAS^2
thrust::device_vector<float>* JtF2 = NULL; ///< preallocated memory NUM_THETAS
...
//added by ZH
__device__ int _num_points;
thrust::device_vector<int>* _point_index = NULL;
thrust::device_vector<float3> *_point_cloud = NULL;

//interaction term 
__device__ float4 *_warped_vertex = NULL;
__device__ float4 *_warped_normal = NULL;
__device__ unsigned char *_vertex_joint_idx = NULL;
__device__ int3 *_sphere_block = NULL;
__device__ float3 *_sphere_coordinate = NULL;
__device__ unsigned char *_vertex_block_idx = NULL;
thrust::device_vector<unsigned char> *finger2block_idx = NULL;
thrust::device_vector<unsigned char> *finger2joint_point_idx = NULL;
thrust::device_vector<int>* interaction_indices = NULL;
thrust::device_vector<glm::mat3x3>* rigid_mot_r = NULL;
thrust::device_vector<glm::vec3>* rigid_mot_t = NULL;
glm::mat3x3* rigid_motion_r;
glm::vec3* rigid_motion_t;
...
__device__ float3 _camera_ray_dir;
...
thrust::device_vector<int>* device_confidence = NULL;
