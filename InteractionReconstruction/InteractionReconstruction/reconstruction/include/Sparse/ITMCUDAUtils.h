...
template <typename T> 
__device__ int computePrefixSum_device(ORUuint element, T *sum, int localSize, int localId)
{
	// TODO: should be localSize...
	__shared__ ORUuint prefixBuffer[16 * 16];
	__shared__ ORUuint groupOffset;
