...
namespace ITMLib
{
	namespace Objects
	{
		...
		*/
		...
		{
		private:
			ORUtils::MemoryBlock<TVoxel> *voxelBlocks;///ZH: actually the sparse voxel
...
//				allocationList = new ORUtils::MemoryBlock<int>(0, memoryType);//new ORUtils::MemoryBlock<int>(noBlocks, memoryType);
				allocationList = NULL;
			}
