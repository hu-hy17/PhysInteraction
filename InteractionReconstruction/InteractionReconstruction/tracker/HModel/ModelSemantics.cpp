...
void ModelSemantics::setup_dofs() {
	...
	// thumb flexion 2
	model->dofs[11].min = -0.9;	// -0.9
	model->dofs[11].max = 0.2;	// 0.2 0.9
	// thumb flexion 3
	model->dofs[12].min = -0.9;	// -0.9 -1.4
	model->dofs[12].max = 0.1;	// 0.1 0.7
